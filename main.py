...
import textwrap
"""
Os métodos abstractclassmethod e abstractproperty estão depreciados,
utilizarei os métodos 'classmethod' e 'property' respectivamente
"""
        ...
        self._transacoes.append(
            {
                ...
                "data":datetime.now().strftime("%d-%m-%Y %H:%M:%s")#vírgula?
            }
        )
...
def criar_cliente(clientes):
    ...
    print("\n __ Cliente criado com sucesso! __")
...
def criar_conta(numero_conta, clientes, contas):
    ...
    print("\n __ Conta criada com sucesso! __")
